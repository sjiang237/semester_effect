...
Testing Partial dependence plot 
```{r}
...
pdp_grit <- partial(
  object = fit_rf$fit,               # Extract the fitted ranger model
  pred.var = "grit_overall",         # Specify the feature
  train = feat_trn_rf                # Training data
)

# Plot the Partial Dependence Plot
plot(pdp_grit, main = "Partial Dependence Plot for Grit Overall")
